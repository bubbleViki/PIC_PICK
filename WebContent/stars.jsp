				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="#"></a></li>
							<li><a href="http://localhost:8080/PIC_PICK/stars_select.jsp">SELECT</a></li>
							<li class="divider"></li>
							<li><a href="#">VIEW</a></li>
						</ul></li>
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li class="divider"></li>
							<li><a href="http://localhost:8080/PIC_PICK/index.jsp">Exit</a></li>
						</ul></li>
				</ul>
		...
		<div class="l-container">
				...
				<div class="title title--search-info l-row l-lg-8 l-md-6 l-sm-12 ">
					...
					<div class="photos" data-row-grid="{&quot;minMargin&quot;:5,&quot;maxMargin&quot;:5,&quot;itemSelector&quot;:&quot;.photo-item&quot;,&quot;firstItemClass&quot;:&quot;first-item&quot;,&quot;lastRowClass&quot;:&quot;last-row&quot;,&quot;resize&quot;:true,&quot;minWidth&quot;:426}">
						<input type="checkbox" name="chsId" value="${book.bookId}" />
						<article class="photo-item first-item" style="width: 447px; height: 251px; margin-right: 5px;">
							<a href="http://localhost:8080/PIC_PICK/detailPage.jsp" title="Blue and Black Starry Sky">
								<img width="622" height="350" style="background:rgb(19,24,42)" alt="Blue and Black Starry Sky"  src="static/images/index/index_blackwhite_peo.jpeg" >
							</a>
						</article>
						
						<article class="photo-item" style="width: 377px; height: 251px; margin-right: 5px;">
							<a href="#" title="vikiii">
								<img width="525" height="350" style="background:rgb(67,51,41)" alt="Free stock photo of nature, man, person, night"  src="static/images/index/index_blackwhite_peo.jpeg" >
							</a>
						</article>
						
						<article class="photo-item" style="width: 485px; height: 251px;">
						<a href="#" title="">
						<img width="676" height="350" style="background:rgb(56,52,51)" alt="Free stock photo of sky, person, night, silhouette" src="static/images/index/index_blackwhite_peo.jpeg">
						</a>
						</article>
						...
						<article class="photo-item first-item" style="width: 434px; height: 276px; margin-right: 5px;">
							<a href="#" title="Shooting Star during Nighttime With Purple Sky">
								<img width="550" height="350" style="background:rgb(71,35,70)" alt="Shooting Star during Nighttime With Purple Sky"  src="static/images/index/index_blackwhite_peo.jpeg">
							</a>
						</article>
